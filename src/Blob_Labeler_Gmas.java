...
//	}
    ...
    /**
     * Code based on http://homepages.inf.ed.ac.uk/rbf/HIPR2/labeldemo.htm
     */
    ...
    /**
     * Associate(equivalence) a with b. a should be less than b to give some ordering (sorting) if b is already associated with some other value, then propagate down the list.
     */
